...
![image-20220713092903266](3-CSS.assets/202207130929369.png)
...
![image-20220713093014396](3-CSS.assets/202207130930497.png)
...
![image-20220713123439550](3-CSS.assets/202207131235899.png)
...
![img](3-CSS.assets/202205240914963.png)
...
![[外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-DvrOcHPU-1636795283603)(D:/start/image-20211113151011712.png)]](3-CSS.assets/202205240914474.png)
...
![[外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-mnnGPLTy-1636795283604)(D:/start/image-20211113152312104.png)]](3-CSS.assets/202205240915668.png)
...
![[外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-8w95miyC-1636795283606)(D:/start/image-20211113153138009.png)]](3-CSS.assets/202205240915784.png)
...
![[图片)]](3-CSS.assets/202205240915893.png)
...
![image-20220714151257243](3-CSS.assets/202207141512355.png)
...
![image-20220718084922302](3-CSS.assets/image-20220718084922302.png)

页面中的任何一个元素在显示和处理时都是以一个盒子的方式进行处理的.

![image-20220715105511971](3-CSS.assets/202207151055089.png)
...
![在这里插入图片描述](3-CSS.assets/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBAeGltaW5neA==,size_18,color_FFFFFF,t_70,g_se,x_16.png)

在此基础之上，如果给`div1`增加`float: left`属性后，效果如下：

![在这里插入图片描述](3-CSS.assets/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBAeGltaW5neA==,size_20,color_FFFFFF,t_70,g_se,x_16.png)
...
![在这里插入图片描述](3-CSS.assets/4b46b08044d043ebb6fa0b569ba5c276.png)
...
![在这里插入图片描述](3-CSS.assets/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBAeGltaW5neA==,size_20,color_FFFFFF,t_70,g_se,x_16-165810555885327.png)
我们再修改 css 样式, 使得其发生右浮动
![在这里插入图片描述](3-CSS.assets/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBAeGltaW5neA==,size_20,color_FFFFFF,t_70,g_se,x_16-165810556180030.png)
在这里,我们就可以解释上面前两条特性了
...
结果正如前两条理论一样
![在这里插入图片描述](3-CSS.assets/fd847529a26842f0937d1260ae686a16.png)
...
![在这里插入图片描述](3-CSS.assets/c9c368949b664bceb1bf36ee61515f14.png)
...
![在这里插入图片描述](3-CSS.assets/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBAeGltaW5neA==,size_20,color_FFFFFF,t_70,g_se,x_16-165810557200837.png)
...
![在这里插入图片描述](3-CSS.assets/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBAeGltaW5neA==,size_20,color_FFFFFF,t_70,g_se,x_16-165810557507940.png)
...
![在这里插入图片描述](3-CSS.assets/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBAeGltaW5neA==,size_20,color_FFFFFF,t_70,g_se,x_16-165810557844643.png)
...
![在这里插入图片描述](3-CSS.assets/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBAeGltaW5neA==,size_20,color_FFFFFF,t_70,g_se,x_16-165810558082146.png)
...
![在这里插入图片描述](3-CSS.assets/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBAeGltaW5neA==,size_20,color_FFFFFF,t_70,g_se,x_16-165810558347549.png)
或者可这么玩
...
![在这里插入图片描述](3-CSS.assets/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBAeGltaW5neA==,size_20,color_FFFFFF,t_70,g_se,x_16-165810558823352.png)
明白了原理, 一切好说
...
![在这里插入图片描述](3-CSS.assets/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBAeGltaW5neA==,size_20,color_FFFFFF,t_70,g_se,x_16-165810559067655.png)
...
![在这里插入图片描述](3-CSS.assets/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBAeGltaW5neA==,size_20,color_FFFFFF,t_70,g_se,x_16-165810559642058.png)
...
当你看到这里的时候, 我其实想说, 最后我觉得, 记笔记其实效率远远不如直接看文档, 但是, 之前的笔记确实有过很大的帮助
